...
Quite suprisingly, the graphs of sentiments from different regions seem almostly identical. 

### It turns out that even if the topics and languages differ, the emotions and feelings of songs are all the same for people around the world. Joy, anticipation and trust for the most moments, but also sadness and anger. This distribution of emotions seem to be universal, across all types of musics.
Assumingly, if we seperate the lyrics into different types of musics, then Rock would probably have a different distribution of emotions from Jazz and Folk. But with all types of musics mixed up, the difference of regions would not bring a noticable difference to this distribution. It appears that we have found a universal pattern of sentiments in lyrics all over the world.

## Conclusion
The usage of words can differ from regions, and the topics that different regions would prefer are not quite the same, yet consistent with common senses. The proportions of emotions expressed would not, however, change with regions. There seem to be a universal pattern of sentiment that human sing about.
